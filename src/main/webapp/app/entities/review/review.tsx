  ...
  return (
    <div>
      <h2 id="review-heading" data-cy="ReviewHeading">
        <Translate contentKey="estetlyApp.review.home.title">Reviews</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="estetlyApp.review.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/review/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="estetlyApp.review.home.createLabel">Create new Review</Translate>
          </Link>
        </div>
      </h2>
        ...
        {reviewList && reviewList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="estetlyApp.review.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <th className="hand" onClick={sort('rate')}>
                  <Translate contentKey="estetlyApp.review.rate">Rate</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('rate')} />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="estetlyApp.review.home.notFound">No Reviews found</Translate>
            </div>
          )
        )}
      </div>
