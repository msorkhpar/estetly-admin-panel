...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './doctor-procedure-association.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOCTORPROCEDUREASSOCIATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_DOCTORPROCEDUREASSOCIATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DOCTORPROCEDUREASSOCIATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DOCTORPROCEDUREASSOCIATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DOCTORPROCEDUREASSOCIATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DOCTORPROCEDUREASSOCIATION actions', async () => {
      const expectedActions = [
        {
