...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './body-area-concern-association.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BODYAREACONCERNASSOCIATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_BODYAREACONCERNASSOCIATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BODYAREACONCERNASSOCIATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BODYAREACONCERNASSOCIATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BODYAREACONCERNASSOCIATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BODYAREACONCERNASSOCIATION actions', async () => {
      const expectedActions = [
        {
