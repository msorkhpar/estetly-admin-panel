  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="estetlyApp.doctor.home.createOrEditLabel" data-cy="DoctorCreateUpdateHeading">
            <Translate contentKey="estetlyApp.doctor.home.createOrEditLabel">Create or edit a Doctor</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('estetlyApp.doctor.name')}
                id="doctor-name"
                name="name"
                data-cy="name"
                type="text"
