  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="estetlyApp.category.home.createOrEditLabel" data-cy="CategoryCreateUpdateHeading">
            <Translate contentKey="estetlyApp.category.home.createOrEditLabel">Create or edit a Category</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('estetlyApp.category.name')}
                id="category-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              <ValidatedField label={translate('estetlyApp.category.model')} id="category-model" name="model" data-cy="model" type="select">
                {modelsValues.map(models => (
                  <option value={models} key={models}>
                    {translate('estetlyApp.Models.' + models)}
                  </option>
                ))}
              </ValidatedField>
