...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './concern.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONCERN_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONCERN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONCERN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONCERN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONCERN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONCERN actions', async () => {
      const expectedActions = [
        {
