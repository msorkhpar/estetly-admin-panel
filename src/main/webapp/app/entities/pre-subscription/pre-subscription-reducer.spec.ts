...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRESUBSCRIPTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRESUBSCRIPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRESUBSCRIPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRESUBSCRIPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRESUBSCRIPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRESUBSCRIPTION actions', async () => {
      const expectedActions = [
        {
