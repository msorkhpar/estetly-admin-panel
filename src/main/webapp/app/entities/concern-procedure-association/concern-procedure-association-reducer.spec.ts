...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './concern-procedure-association.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONCERNPROCEDUREASSOCIATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONCERNPROCEDUREASSOCIATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONCERNPROCEDUREASSOCIATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONCERNPROCEDUREASSOCIATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONCERNPROCEDUREASSOCIATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONCERNPROCEDUREASSOCIATION actions', async () => {
      const expectedActions = [
        {
