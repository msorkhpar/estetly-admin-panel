...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './body-area.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BODYAREA_LIST actions', async () => {
    ...
    it('dispatches FETCH_BODYAREA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BODYAREA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BODYAREA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BODYAREA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BODYAREA actions', async () => {
      const expectedActions = [
        {
