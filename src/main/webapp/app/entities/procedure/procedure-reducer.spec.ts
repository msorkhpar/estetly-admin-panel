...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './procedure.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROCEDURE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROCEDURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROCEDURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROCEDURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROCEDURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROCEDURE actions', async () => {
      const expectedActions = [
        {
