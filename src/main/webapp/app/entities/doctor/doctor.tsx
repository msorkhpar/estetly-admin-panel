  ...
  return (
    <div>
      <h2 id="doctor-heading" data-cy="DoctorHeading">
        <Translate contentKey="estetlyApp.doctor.home.title">Doctors</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="estetlyApp.doctor.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/doctor/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="estetlyApp.doctor.home.createLabel">Create new Doctor</Translate>
          </Link>
        </div>
      </h2>
        ...
        {doctorList && doctorList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="estetlyApp.doctor.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="estetlyApp.doctor.name">Name</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('name')} />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="estetlyApp.doctor.home.notFound">No Doctors found</Translate>
            </div>
          )
        )}
      </div>
