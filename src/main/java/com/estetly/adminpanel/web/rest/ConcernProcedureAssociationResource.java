...
public class ConcernProcedureAssociationResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<ConcernProcedureAssociation>> getAllConcernProcedureAssociations(
        @org.springdoc.core.annotations.ParameterObject Pageable pageable,
        @RequestParam(name = "eagerload", required = false, defaultValue = "true") boolean eagerload
    ) {
        log.debug("REST request to get a page of ConcernProcedureAssociations");
        Page<ConcernProcedureAssociation> page;
        if (eagerload) {
            page = concernProcedureAssociationRepository.findAllWithEagerRelationships(pageable);
        } else {
            page = concernProcedureAssociationRepository.findAll(pageable);
        }
